...
export declare class NodemailerMocked implements NodemailerMock {
    nodemailer: NodemailerType | undefined;
...
export declare const createTransport: (transport?: Transport | Mail.Options | {
    [key: string]: unknown;
}, options?: Mail.Options) => NodemailerMockTransporter, mock: {
    /**
     * reset mock values to defaults
     */
    reset: () => void;
